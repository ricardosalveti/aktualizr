...
CREATE TABLE installed_versions_log(id INTEGER PRIMARY KEY, ecu_serial TEXT NOT NULL, generation INTEGER NOT NULL, installed_version_id INTEGER, FOREIGN KEY(installed_version_id) REFERENCES installed_versions(id) UNIQUE (ecu_serial, generation));
